...
public class TomorrowWeatherAdapter extends RecyclerView.Adapter<TomorrowWeatherAdapter.VH> {

    private List<Forecast> data;
    private LayoutInflater inflater;
    private PictureAdapter pictureAdapter = new PictureAdapter();

    public TomorrowWeatherAdapter(Context context){
    ...
    public class VH extends RecyclerView.ViewHolder{
        ...
        public void fill(Forecast forecast, int position){
            ...
            ivImage.setImageResource(pictureAdapter.setImage(forecast.getWeather().get(0).getIcon()));
        }
    }
}
