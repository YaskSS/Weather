...
public class SettingsActivity extends AppCompatActivity {
    ...
    private RadioButton twoHoursRadioButton;
    private RadioButton threeHourRadioButton;
    private RadioButton russianLanguageRadioButton;
    private RadioButton englishLanguageRadioButton;
    ...
    private CheckBox cloudinessCheckBox;
