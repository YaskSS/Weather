...
public class SharedPrefHelper {
    ...
    public BackNow getWeatherDataNow() {
    ...
    public boolean saveWeatherDataNow(BackNow backNowData) {
        // Obtain previously saved
        if (backNowData == null) {
            Log.i(TAG, "saveWeatherDataNow = false");
            return false;
        } else {
            ...
            Log.i(TAG, "saveWeatherDataNow = true");
            return true;
        }
    }
